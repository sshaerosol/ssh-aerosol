...
contains
  ...
  end subroutine initialisation_repart_coeff
  ...
  subroutine launch_ssh_aerosolonly(namelist_ssh,nbins,nspecies,duration,temp,pres,relh,gas_conc,aero_conc,number)
    ! Computes aerosol formation
    !    With internal mixing
    !    Inviscid organic aerosol (only one layer)
