...
c genoa         write(*,*) 'For some specific reaction constants ',mechanism_name
c genoa         write(*,*) mechanism_name
...
c genoa	    write(*,*) '   expressions in MELCHIOR2 mechanism are used'
