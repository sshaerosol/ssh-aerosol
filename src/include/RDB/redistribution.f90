...
!!$------------------------------------------------------------------------
  ...
  if(scheme.EQ.11) then
    call REDIST(ns,naer,N,Qesp,fixed_density,rho,dbound,d_after_cond)
  else
...
!*     *
!**************************************************
      SUBROUTINE REDIST(ns,naer,n,q,fixed_density,rho,dbound,diam)
!**************************************************
!*     *
...
!**************************************************
      ...
      DOUBLE PRECISION CST,fixed_density,rho(ns)
