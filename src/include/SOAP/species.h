...
{  
  ...
  public:
    ...
    Array<double, 2> Inter_org, Inter_aq, Inter2_aq, Inter2_org, Inter2_tot, Inter_tot, groups_org, groups_aq, groups_tot, logInter2_org, logInter2_aq, logInter2_tot;
    Array<double, 1> ln_eta0_org,ln_eta0_aq,ln_eta0_tot;
    ...
    Array<double,1> param_aiomfac_visctot, param_aiomfac_viscorg, param_aiomfac_viscaq;
    Array<double,3> viscosity_layer;
