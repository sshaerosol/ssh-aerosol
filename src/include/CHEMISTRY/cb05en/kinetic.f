...
C     WetDiam: Bins wet Diameter ([mu m])
...
C
     ...
     & - ( -0.3570000000000000D+03 )/temp)
      ...
      rk(207) =  DEXP(-0.2450865619144119D+02
     & - ( -0.4350000000000000D+03 )/temp)
C    Heteroheneous Reactions on aerosol surface:
C
C    Reaction 156: HO2  -->  0.5 H2O2
C    Reaction 157: NO2  -->  0.5 HONO + 0.5 HNO3
C    Reaction 158: NO3  -->  HNO3
C    Reaction 159: N2O5 -->  2 HNO3
