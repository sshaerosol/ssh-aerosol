...
!     For the zenithal angle at tropics
  ...
  rk(  3) =  exp( -0.2653240882726044D+02 &
   - (  0.1500000000000000D+04 )/temp)
  rk(  4) =  exp( -0.2590825451818744D+02 &
  ...
  rk(  6) = (Effko * SumM / &
    ...
    0.6000D+00** (1.0d0 / (1.0d0 + &
    (log10(Effko * SumM / Rapk))**2))
  rk(  7) =  exp( -0.2975128465212864D+02 &
  ...
  !
  rk( 10) =  exp( -0.2458649867820512D+02 &
   - ( -0.1020000000000000D+03 )/temp)
  rk( 10) = rk( 10) * SumM
  rk( 11) =  0.2200000000000000D-09
  rk( 11) = rk( 11) * YlH2O
  rk( 12) =  exp( -0.2710039286486638D+02 &
   - (  0.9400000000000000D+03 )/temp)
  rk( 13) =  exp( -0.3223619130191664D+02 &
  ...
  !
  rk( 16) =  exp( -0.2492297091482634D+02 &
   - ( -0.1700000000000000D+03 )/temp)
  rk( 17) =  exp( -0.3073211390514037D+02 &
  ...
  Effko =  0.4100000000000000D-04* (temp / 3.d2) &
    **(- ( 0.0000000000000000D+00))* &
    exp(- 0.1065000000000000D+05/temp)
  Rapk =  0.4800000000000000D+16* (temp / 3.d2) &
    **(- ( 0.0000000000000000D+00))* &
    exp(- 0.1117000000000000D+05/temp)
  rk( 31) = (Effko*SumM / ( 1.0d0 + Effko * SumM / &
    Rapk)) * 0.6000D+00** (1.0d0 / (1.0d0 + &
    (log10(Effko * SumM / Rapk))**2))
  rk( 32) =  exp( -0.2736865685146106D+02 &
   - ( -0.3800000000000000D+03 )/temp)
  rk( 33) = 2.3d-13 * exp(600.0d0 / temp) &
    + 1.7d-33* SumM * exp(1000.0d0 / temp)
  rk( 34) = 3.22d-34 * exp(2800.0d0 / temp) &
  ...
  !
  rk( 53) =  exp( -0.2667550967090111D+02 &
   - ( -0.3650000000000000D+03 )/temp)
  rk( 54) =  exp( -0.2667550967090111D+02 &
   - ( -0.3650000000000000D+03 )/temp)
  rk( 55) =  exp( -0.2791870318838033D+02 &
   - ( -0.7000000000000000D+03 )/temp)
  rk( 56) =  exp( -0.2791870318838033D+02 &
   - ( -0.7000000000000000D+03 )/temp)
  rk( 57) =  0.6800000000000000D-13
  rk( 58) =  0.6800000000000000D-13
  rk( 59) =  0.6800000000000000D-13
  rk( 60) =  exp( -0.2815865385801092D+02 &
  ...
  !
  rk( 62) =  exp( -0.2652908103716776D+02 &
  ...
  rk( 64) = 1.44d-13 * (1.0d0 + 2.381d-20 * &
    8.0d-1 * SumM)
  rk( 65) =  exp( -0.2673493309137191D+02 &
   - (  0.1775000000000000D+04 )/temp)
  rk( 66) =  exp( -0.2660140169874739D+02 &
   - ( -0.3000000000000000D+03 )/temp)
  rk( 67) =  exp( -0.2852261923521233D+02 &
   - ( -0.7500000000000000D+03 )/temp)
  rk( 68) =  exp( -0.2998489950331015D+02 &
   - ( -0.3900000000000000D+03 )/temp)
  rk( 69) =  exp( -0.2629602004919621D+02 &
   - ( -0.2000000000000000D+03 )/temp)
  !
  if(option_photolysis.eq.2) then
    rk( 70)= 0.D0
  ...
  !
  rk( 71) =  exp( -0.2564314676777420D+02 &
  ...
  !
  rk( 86) =  exp( -0.2553915705425015D+02 &
   - ( -0.2700000000000000D+03 )/temp)
  ...
  Effko =  0.4900000000000000D-02* (temp / 3.d2) &
    **(- ( 0.0000000000000000D+00))* &
    exp(- 0.1210000000000000D+05/temp)
  Rapk =  0.5400000000000000D+17* (temp / 3.d2) &
    **(- ( 0.0000000000000000D+00))* &
    exp(- 0.1383000000000000D+05/temp)
  ...
  !
  rk( 90) =  exp( -0.2847499118622308D+02 &
   - ( -0.1040000000000000D+04 )/temp)
  rk( 91) =  exp( -0.2693787393536860D+02 &
   - ( -0.5000000000000000D+03 )/temp)
  rk( 92) =  exp( -0.2845200166799838D+02 &
   - ( -0.1070000000000000D+04 )/temp)
  rk( 93) =  exp( -0.2656631037893612D+02 &
   - ( -0.5000000000000000D+03 )/temp)
  rk( 94) =  exp( -0.2854731184780270D+02 &
   - ( -0.2000000000000000D+03 )/temp)
  !
  if(option_photolysis.eq.2) then
    rk( 95)= 0.D0
  ...
  !
  rk( 96) =  exp( -0.2854731184780270D+02 &
   - ( -0.2000000000000000D+03 )/temp)
  rk( 97) =  exp( -0.2506607175846701D+02 &
   - (  0.8700000000000000D+03 )/temp)
  rk( 98) =  exp( -0.2600178057619827D+02 &
  ...
  !
  rk(101) =  exp( -0.2572891358953163D+02 &
  ...
  rk(106) =  exp( -0.2847499118622308D+02 &
   - ( -0.1040000000000000D+04 )/temp)
  rk(107) =  exp( -0.2693787393536860D+02 &
   - ( -0.5000000000000000D+03 )/temp)
  rk(108) =  exp( -0.2845200166799838D+02 &
   - ( -0.1070000000000000D+04 )/temp)
  rk(109) =  exp( -0.2656631037893612D+02 &
   - ( -0.5000000000000000D+03 )/temp)
  rk(110) =  exp( -0.2656631037893612D+02 &
   - ( -0.5000000000000000D+03 )/temp)
  rk(111) =  0.8100000000000000D-12
  rk(112) =  exp(  0.3453877639491068D+02 &
   - (  0.8000000000000000D+04 )/temp)
  rk(113) =  0.1600000000000000D+04
  rk(114) =  0.1500000000000000D-10
  rk(115) =  exp( -0.2531848569208134D+02 &
   - (  0.2800000000000000D+03 )/temp)
  rk(116) =  0.3200000000000000D-10
  rk(117) =  exp( -0.3266697421800909D+02 &
   - (  0.1900000000000000D+04 )/temp)
  rk(118) =  exp( -0.2798769605986728D+02 &
   - (  0.2160000000000000D+04 )/temp)
  rk(119) =  exp( -0.2499196378631329D+02 &
  ...
  rk(120) = (Effko * SumM / &
    ...
    0.6000D+00** (1.0d0 / (1.0d0 + &
    (log10(Effko * SumM / Rapk))**2))
  rk(121) =  exp( -0.3205386974512268D+02 &
   - (  0.2630000000000000D+04 )/temp)
  rk(122) =  exp( -0.2643709864745611D+02 &
   - (  0.2880000000000000D+04 )/temp)
  rk(123) =  0.2300000000000000D-10
  rk(124) =  exp( -0.2532843602293450D+02 &
   - ( -0.5500000000000000D+03 )/temp)
  rk(125) =  exp( -0.3241054468906142D+02 &
   - (  0.1100000000000000D+04 )/temp)
  rk(126) =  exp( -0.2767184311044880D+02 &
   - (  0.2700000000000000D+03 )/temp)
  rk(127) =  exp( -0.2704323445102643D+02 &
  ...
  rk(136) =  exp( -0.3745754762732854D+02 &
   - (  0.5000000000000000D+03 )/temp)
  rk(137) =  exp( -0.2479780777187233D+02 &
  ...
  rk(141) =  exp( -0.2439627194190406D+02 &
   - ( -0.4076000000000000D+03 )/temp)
  rk(142) =  exp( -0.3247698978846957D+02 &
   - (  0.1912000000000000D+04 )/temp)
  rk(143) =  exp( -0.2652245849640727D+02 &
  ...
  rk(148) = (Effko * SumM / &
    ...
    0.6000D+00** (1.0d0 / (1.0d0 + &
    (log10(Effko * SumM / Rapk))**2))
  rk(149) =  exp( -0.2569949970432533D+02 &
   - (  0.2300000000000000D+03 )/temp)
  rk(150) =  exp( -0.2546769809026801D+02 &
   - (  0.1070000000000000D+04 )/temp)
  ...
  rk(156) =  exp( -0.2513781566332585D+02 &
   - ( -0.4440000000000000D+03 )/temp)
  rk(157) =  exp( -0.3523192357547063D+02 &
   - (  0.5300000000000000D+03 )/temp)
  rk(158) =  exp( -0.2745706780880511D+02 &
   - ( -0.4900000000000000D+03 )/temp)
  rk(159) =  exp( -0.2389335149764518D+02 &
   - ( -0.4010000000000000D+03 )/temp)
  rk(160) =  exp( -0.3345697122455896D+02 &
   - (  0.7830000000000000D+03 )/temp)
  rk(161) =  0.1220000000000000D-10
  rk(162) =  exp( -0.2861185036894027D+02 &
   - ( -0.9800000000000000D+03 )/temp)
  rk(163) =  exp( -0.3096643075705270D+02 &
   - ( -0.7080000000000000D+03 )/temp)
  rk(164) =  exp( -0.2793212620871247D+02 &
   - ( -0.7650000000000000D+03 )/temp)
  rk(165) =  exp( -0.2663776934291826D+02 &
   - ( -0.3600000000000000D+03 )/temp)
  rk(166) =  0.1200000000000000D-11
  rk(167) =  exp( -0.2861185036894027D+02 &
   - ( -0.9800000000000000D+03 )/temp)
  rk(168) =  exp( -0.3096643075705270D+02 &
   - ( -0.7080000000000000D+03 )/temp)
  rk(169) =  exp( -0.2793212620871247D+02 &
   - ( -0.7650000000000000D+03 )/temp)
  rk(170) =  exp( -0.2663776934291826D+02 &
   - ( -0.3600000000000000D+03 )/temp)
  rk(171) =  0.1200000000000000D-11
  rk(172) =  exp( -0.2921576641577228D+02 &
   - ( -0.1300000000000000D+04 )/temp)
  rk(173) =  exp( -0.3101241587029453D+02 &
   - ( -0.2210000000000000D+03 )/temp)
  rk(174) =  exp( -0.3010795959606737D+02 &
   - ( -0.2210000000000000D+03 )/temp)
  rk(175) =  0.1200000000000000D-11
  rk(176) =  0.1200000000000000D-11
  rk(177) =  0.1300000000000000D-10
  rk(178) =  0.6610000000000000D-12
  rk(179) =  exp( -0.2669885703489810D+02 &
   - ( -0.3600000000000000D+03 )/temp)
  rk(180) =  exp( -0.2933476970783389D+02 &
   - ( -0.1300000000000000D+04 )/temp)
  rk(181) =  exp( -0.3101241587029453D+02 &
   - ( -0.2210000000000000D+03 )/temp)
  rk(182) =  exp( -0.2660140169874739D+02 &
   - ( -0.1810000000000000D+03 )/temp)
  rk(183) =  exp(  0.3731136511715047D+02 &
  ...
  rk(188) =  exp( -0.2446133553525112D+02 &
