...
C     Routine dimensions.f90
      nficdim90=ipiste
      ipiste=ipiste+1
      open(nficdim90,file='dimensions_90.f90',status='new')
      nwrite=nficdim90
...
C     Routine kinetic.f90
      nfick90=ipiste
      ipiste=ipiste+1
      open(nfick90,file='kinetic_90.f90',status='new')
      nwrite=nfick90
...
C===========
 ...
 401  format('subroutine kinetic90',a,'( &')
      write(nwrite,4011)
...
C==========
 ...
 4014 format('subroutine kinetic90',a,'( &')
      write(nwrite,4015)
...
C     Routine fexchem.f90
      nficf90=ipiste
      ipiste=ipiste+1
      open(nficf90,file='fexchem_90.f90',status='new')
      nwrite=nficf90
...
C     Routine jacdchemdc.f90
      nficj90=ipiste
      ipiste=ipiste+1
      open(nficj90,file='jacdchemdc_90.f90',status='new')
      nwrite=nficj90

      call write_common_header_90(nwrite)

      write(nwrite,601) function_suffix
 601  format('subroutine jacdchemdc90',a,'( &')
      write(nwrite,6011)
 6011 format(4x,
...
C     Routine fexloss.f90
      nficloss90=ipiste
      ipiste=ipiste+1
      open(nficloss90,file='fexloss_90.f90',status='new')
      nwrite=nficloss90

      call write_common_header_90(nwrite)

      write(nwrite,701) function_suffix
 701  format('subroutine fexloss90',a,'( &')
      write(nwrite,7011)
...
C     Routine fexprod.f90
      nficprod90=ipiste
      ipiste=ipiste+1
      open(nficprod90,file='fexprod_90.f90',status='new')
      nwrite=nficprod90

      call write_common_header_90(nwrite)

      write(nwrite,801) function_suffix
 801  format('subroutine fexprod90',a,'( &')
      write(nwrite,8011)
...
C     Routine rates.f90
      nficw90=ipiste
      ipiste=ipiste+1
      open(nficw90,file='rates_90.f90',status='new')
      nwrite=nficw90

      call write_common_header_90(nwrite)

      write(nwrite,901) function_suffix
 901  format('subroutine rates90',a,'( &')
      write(nwrite,9011)
...
C     Routine dratedc.f90
      nficdw90=ipiste
      ipiste=ipiste+1
      open(nficdw90,file='dratedc_90.f90',status='new')
      nwrite=nficdw90

      call write_common_header_90(nwrite)

      write(nwrite,910) function_suffix
 910  format('subroutine dratedc90',a,'( &')
      write(nwrite,9101)
...
C     File non_zero.dat
      nficnz90=ipiste
      ipiste=ipiste+1
      open(nficnz90,file='non_zero_90.dat',status='new')
C
 150  format('!',6x,a65)
 200  format('!-----------------------------------',
     2     '-------------------------------------')
