...
ppoa = poa1 + poa2 + poa3
totsoa = poa1 + poa2 + poa3 + soa1 + soa2 + soa3 + soa4 + soa5 + soa6
ssoa = soa1+soa2 + soa3
hsoa = soa5 + soa6
...
ax.plot(time, totsoa,'k-',label='total')
ax.plot(time, hsoa,'navy',label='SOA from VOC oxid. - high NOx')
ax.plot(time, soa4,'b-',label='SOA from VOC oxid. - low NOx')
ax.plot(time, ssoa,'c-',label='SOA from SVOC oxid.')
ax.plot(time, ppoa,'g-',label='Primary SVOC')
