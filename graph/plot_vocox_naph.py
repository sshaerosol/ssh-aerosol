...
species_tol={'PNaNKON','PNaHKON','PNaOKON','PNaKKON','PPhNDKD','PPhGND','PPhAND','PPhPND','PPhNA','PPhNG','PPhNP','PPhAnhy','PPhEstH','PPhEstO','PPhGA','PPhAA','PPhPA','PHPhA','POPhA','PVOPhA','PPhGD','PPhPD','PHPhD','PVOPhD','PNaOOO','PNaVOO','PNaHO','PNaOOK','PNaOOONBp','PNaOOOHBp','PNaOOOOBp','PGLYA','PGLYG','PPhOHEst','PPhOOEst','PPhPOA','PPhGOA','PPhAOA','PPhPOD','PPhGOD','PPhAKA','PPhOAnhy'}
for species in species_tol:
...
plt.legend(loc=2)
plt.savefig("particles-vocox-naph.png",bbox_inches='tight')
plt.tight_layout()
plt.close(fig)
