...
plt.ioff()
################### input parameters #################################"
dir2 = '../results/aerosol-vocox/ref-expl/aero/'
dir3 = '../results/aerosol-vocox/ref-expl-dNO2/aero/'
dir4 = '../results/aerosol-vocox/ref-expl-mNO2/aero/'
dir5 = '../results/aerosol-vocox/ref-rdc/aero/'
dir6 = '../results/aerosol-vocox/ref-rdc-dNO2/aero/'
dir7 = '../results/aerosol-vocox/ref-rdc-mNO2/aero/'
...
plt.plot(time, tolcompl,color='k',label='Rdc - Ref')
plt.plot(time, tolcomplmNO2,'m',label='Rdc - NO$_2$ x 1.5')
plt.plot(time, tolcompldNO2,'b',label='Rdc - NO$_2$ / 1.5')
plt.plot(time, tol,color='k', linestyle='dashed',label='Expl. - Ref')
plt.plot(time, tolmNO2,'m', linestyle='dashed',label='Expl. - NO$_2$ x 1.5')
plt.plot(time, toldNO2,'b', linestyle='dashed',label='Expl. - NO$_2$ / 1.5')
plt.ylabel("$\mu g.m^{-3}$", fontsize=18)
plt.xlabel("time [h]", fontsize=18)
plt.legend(loc=2)
plt.savefig("particles-vocox-monoterp-rdc.png",bbox_inches='tight')
plt.tight_layout()
plt.close(fig)
