...
plt.plot(time, tolcomplmNO2,'m',label='Rdc - NO$_2$ x 2')
plt.plot(time, tolcompldNO2,'b',label='Rdc - NO$_2$ / 2')
plt.plot(time, tol,color='k', linestyle='dashed',label='Expl. - Ref')
plt.plot(time, tolmNO2,'m', linestyle='dashed',label='Expl. - NO$_2$ x 2')
plt.plot(time, toldNO2,'b', linestyle='dashed',label='Expl. - NO$_2$ / 2')
