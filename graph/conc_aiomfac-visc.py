...
figure()
semilogx(t,visco13,'lightblue',label='C=14') #m$^2$ s$^{-1}$')
semilogx(t,visco14,'b',label='C=15') #m$^2$ s$^{-1}$')
semilogx(t,visco3,'c',label='C=16') #m$^2$ s$^{-1}$')
semilogx(t,visco15,'y',label='C=17') #m$^2$ s$^{-1}$')
semilogx(t,visco16,'g',label='C=18') #m$^2$ s$^{-1}$')
semilogx(t,visco17,'purple',label='C=19') #m$^2$ s$^{-1}$')
semilogx(t,visco18,'m',label='C=20') #m$^2$ s$^{-1}$')
semilogx(t,visco19,'r',label='C=21') #m$^2$ s$^{-1}$')
semilogx(t,visco20,'k',label='C=22') #m$^2$ s$^{-1}$')
#semilogx(t,visco8,'k',label='10$^{-24}$') #m$^2$ s$^{-1}$')
title("Condensation on aerosol with 2 OH groups and RH=10%\n with different number of carbons",fontsize=15)
xlabel('Time (h)',fontsize=12)
ylabel('POAmP concentrations (ng m$^{-3}$)',fontsize=12)
legend(loc ='best')        
