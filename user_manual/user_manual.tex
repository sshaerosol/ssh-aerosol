...
compound, the mass concentration is defined for each layer. Then for each
...
compound is organic and hydrophobic. 

In soap.cpp, the hydrophobic organic-phase concentrations in the different layers are
...
either hydrophobic. This will be improved in further version by saving for
...
illustate this effect, the condensation of hydrophobic organic surrogates of different volatility is studied for different
...
organic compound in the particle. 
...
\begin{figure}[H]
        \begin{center}
                \includegraphics[angle=0,width=0.45\textwidth]{fig/visco_soalp.png}
                \includegraphics[angle=0,width=0.45\textwidth]{fig/visco_poalp.png}
                \includegraphics[angle=0,width=0.45\textwidth]{fig/visco_poamp.png}
        \end{center}
