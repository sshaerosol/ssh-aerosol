...
Particles can be made of dust (PMD), black carbon (PBC), sulfate (PSO4), nitrate (PNO3), ammonium (PNH4), chloride (PCL), sodium (PNA) and organics. Characteritics of the surrogates for aerosol organic species are detailed in Table~\ref{species}.
...
\centering
\begin{tabular}{|c|c|p{2.8cm}|c|c|c|c|c|c|c}
\hline
...
The monomer density is modified in the file {\it{species-list-monomer/species-list-aer-test.dat}}.
